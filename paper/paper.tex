...
\begin{document}
	...
	\begin{figure}[H]
		\fig{
		\includegraphics[width=0.9\textwidth]{pictures/Trainingsprozess_EMG_FFT_vs_kein_FFT2.png}
	...
	\begin{figure}[H]
		\fig{
		\includegraphics[width=0.8\textwidth]{pictures/netzwerkstruktur-emg.png}
	...
	\begin{figure}[H]
		\fig{
		\includegraphics[width=0.9\textwidth]{pictures/Trainingsprozess_EEG_FFT_vs_kein_FFT2.png}
	...
	\begin{figure}[H]
		\fig{
		\includegraphics[width=0.8\textwidth]{pictures/netzwerkstruktur-eeg.png}
