...
\begin{document}
	...
	\begin{figure}[h!]
		\fig{
		\includegraphics[width=0.4\textwidth]{pictures/EEG-Alex-annotated.png}
		...
		\caption{Das EEG und Zubehör. Links sieht man die typische Anwendung des EEG im Versuchsaufbau (Konfiguration 1, s. Abb. \ref{10-20-System}). In der Mitte ist das Ganglion Board genauer dargestellt. Rechts sind eine Flat Elektrode und eine Spike Elektrode zu sehen.}
		\label{EEG-Zubehor}}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{Die Amplituden für die Frequenzen 1-50 Hertz von unseren Trainings- und Testdaten (EEG, Konfiguration 2), berechnet durch die FFT. Jede Linie entspricht einem Datensatz. Bei den blauen wurde geblinzelt, bei den roten nicht.}
		\label{EEG-FFT}}
	\end{figure}
	...
	\begin{table}[H]		
		\begin{tabular}{p{0.5\textwidth}p{0.5\textwidth}}
			...
			\bottomrule
		\end{tabular}
		\caption{Einige Beispieldateien für die Steuerung eines Motors auf ev3dev. \filepath{<x>} ist die Nummer des Motors.}
	...
	\begin{figure}[H]
		...
		\caption{Eine Übersicht des Ablaufs unseres Programmes in einem Diagramm. Den Schwellenwert für die Aktivierung des Output-Neurons haben wir durch Beobachtung des Wertes in Tests sowie Ausprobieren bestimmt.}
	...
	\begin{figure}[H]
		...
		\caption{Struktur unseres neuronalen Netzwerks bei Verwendung von EMG (Konfiguration 1)}
	...
	\begin{figure}[H]
		...
		\caption{Struktur unseres neuronalen Netzwerks bei Verwendung von EEG (Konfiguration 2)}
		\label{eeg-netzstruktur}}
	\end{figure}

	%Vor kurzem haben wir einen wissenschaftlichen Artikel gefunden, in dem Nikolaos Korovesis  et al. beschreiben, wie sie ein Brain-Computer Interface entwickelt haben. \cite{bci-ganglion} Dabei ist uns vor allem aufgefallen, dass ihr Vorgehen sehr ähnlich zu unserem war: Sie haben dasselbe Board verwendet, 
	...
	Die Vorlage des 10-20-Systems in der Abbildung \ref{10-20-System} stammt von \href{https://en.m.wikipedia.org/wiki/File:21\_electrodes\_of\_International\_10-20\_system\_for\_EEG.svg}{https://en.m.wikipedia.org/wiki/\-File:\-21\_\-electrodes\_of\_International\_10-20\_system\_for\_EEG.svg}. Die Abbildung liegt in der Public Domain.
