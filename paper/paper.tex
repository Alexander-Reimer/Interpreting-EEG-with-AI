...
\begin{document}
	...
	BCIs sind Schnittstellen zwischen dem Gehirn und einem Computer, die Kommunikation vom Ghirn zum Computer ermöglichen. Man kann BCIs zum Beispiel für die Steuerung von Prothesen, Drohnen und Robotern nutzen.

	Zum Beispiel haben Forscher aus Standfort ein BCI entwickelt, dass in der Lage ist behinderten Personen wieder die Möglichkeit zu geben nur über ihre Gedanke Nachrichten schreiben zu können.
	
	Wir hoffen, bei der Erarbeitung unseres Projektes, neben dem Erlangen von Erfahrung in diesem interessanten Bereich auch selbst dazu beizutragen. BCIs, die mit sehr teurer Hardware entwickelt werden, sind nämlich bereits ziemlich gut erforscht. Jedoch sind diese BCIs, aufgrund ihres hohen Preises, für den Konsumenten nicht nutzbar. Genau bei diesem Problem wollen wir mit unserem Projekt ansetzten. Wir versuchen nämlich ein BCI zu entwickeln, welches auch mit günstiger Hardware funktioniert. Dabei ist es auch wichtig, dass unser BCI auch ohne spezielles Training auf eine bestimmte Person funktioniert und dass unser BCI auch leicht für die eigenen Zwecke anpassbar ist. Deswegen benutzen wir auch Open Source Software und haben zudem unseren kompletten Code auch auf GitHub veröffentlicht.
	%Dies wollen wir erreichen durch das Entwickeln einer allgemeinen Anwendung, bei der kein vorheriges Trainieren für eine fremde Person benötigt wird, das Umsetzen mit günstiger, für viele bezahlbare Hardware, sowie ein performantes Programm, welches leicht für die eigenen Zwecke anpassbar ist.
	...
	Bei der Erarbeitung des Projektes war es uns wichtig, dass wir Open Source Software verwenden, da es anderen Leuten, die eventuell unsern Code für ihr eignens Projekt nutzen wollen hilft, wenn die Programme die genutzt werden alle öffentlich einsehbar sind. Deswegen haben wir uns auch dazu entschieden unseren gesamten Code auf GitHub zu veröffentlichen.
