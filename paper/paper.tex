...
\begin{document}
	...
	Dabei haben wir uns für das Blinzeln entschieden, da wir es im Graphen zumindest mit bloßen Augen deutlich besser erkennen konnten als Armbewegungen.
	...
	Zwei dieser Elektroden haben wir auf der Stirn platziert, zwei jeweils links und rechts auf dem Schädel, etwas über dem Ohr, da dies die Standard-Aufstellung in der Dokumentation ist (s. Abbildung \ref{10-20-System}) \cite{OpenBCI}. Wir planen, sie basierend auf unseren Ergebnissen wo nötig anzupassen. %!!!
	...
	Uns wurde von Professor Everling empfohlen, die Anwendung der Fourier Transformation zur Vorbereitung der Daten für das neuronale Netz zu bedenken.
	...
	Daraus folgt ein Array (eine Liste) an Werten. Der Index bestimmt, für welche Frequenz der Wert gilt (erster Wert: 1 Hertz, zweiter Wert: 2 Hertz, etc.) und der Wert gibt die Amplitude dieser Sinus-Kurve an. So könnten die Daten auch rekonstruiert werden. \cite{3b1b:fft}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.75\textwidth]{pictures/roboter-annotated.png}
